  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-99999 bg-black bg-opacity-80 px-4 py-5">
      ...
      >
        ...
        <h3 className="text-lg font-semibold mb-4 text-black dark:text-white">Edit Package</h3>
        <form onSubmit={handleSubmit}>
          {['name', 'price', 'invoiceDate', 'status'].map((field) => (
            <div className="mb-5" key={field}>
              ...
              <input
                ...
                name={field}
                value={editedPackage[field as keyof Package].toString()}

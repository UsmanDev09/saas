...
import { useTable, useSortBy, useGlobalFilter, useFilters, usePagination, Column } from "react-table";
...
const DataTableOne: React.FC = () => {
  ...
  const employees = useSelector((state: RootState) => state.tables.employees);

  const data = useMemo(() => employees, [employees]);
  const defaultColumn = useMemo(() => {
    return {
      Filter: ColumnFilter as React.FC<any>,
    };
  }, []);

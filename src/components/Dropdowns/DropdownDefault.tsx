...
const DropdownDefault: React.FC<DropdownDefaultProps> = ({ onDelete, onEdit }) => {
      ...
      >
        ...
        <button 
         ...
         className="flex w-full items-center gap-2 rounded-sm px-4 py-1.5 text-left text-sm hover:bg-gray dark:hover:bg-meta-4">
          ...
          >
            <path
              d="M12.225 2.20005H10.3V1.77505C10.3 1.02505 9.70005 0.425049 8.95005 0.425049H7.02505C6.27505 0.425049 5.67505 1.02505 5.67505 1.77505V2.20005H3.75005C2.65005 2.20005 1.82505 3.05005 1.82505 4.15005V14.175C1.82505 15.275 2.67505 16.125 3.75005 16.125H12.225C13.275 16.125 14.15 15.275 14.15 14.175V4.15005C14.15 3.05005 13.275 2.20005 12.225 2.20005ZM7.02505 1.85005H8.95005V2.20005H7.02505V1.85005ZM12.225 14.15H3.75005V4.15005H12.225V14.15ZM12.225 4.72505H3.75005V4.15005H12.225V4.72505Z"
              fill=""
            />
          </svg>
          Delete
